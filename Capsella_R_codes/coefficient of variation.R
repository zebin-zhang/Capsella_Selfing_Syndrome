...
##################### F - Dco Dcr overlaps
neg_all <- all_CV_Dindices_F$D_CR < 0    & all_CV_Dindices_F$D_CO < 0
neg_0.1 <- all_CV_Dindices_F$D_CR < -0.1 & all_CV_Dindices_F$D_CO < -0.1
neg_0.3 <- all_CV_Dindices_F$D_CR < -0.3 & all_CV_Dindices_F$D_CO < -0.3
neg_0.5 <- all_CV_Dindices_F$D_CR < -0.5 & all_CV_Dindices_F$D_CO < -0.5
neg_0.7 <- all_CV_Dindices_F$D_CR < -0.7 & all_CV_Dindices_F$D_CO < -0.7
neg_0.9 <- all_CV_Dindices_F$D_CR < -0.9 & all_CV_Dindices_F$D_CO < -0.9

pos_all <- all_CV_Dindices_F$D_CR > 0   & all_CV_Dindices_F$D_CO > 0
pos_0.1 <- all_CV_Dindices_F$D_CR > 0.1 & all_CV_Dindices_F$D_CO > 0.1
pos_0.3 <- all_CV_Dindices_F$D_CR > 0.3 & all_CV_Dindices_F$D_CO > 0.3
pos_0.5 <- all_CV_Dindices_F$D_CR > 0.5 & all_CV_Dindices_F$D_CO > 0.5
pos_0.7 <- all_CV_Dindices_F$D_CR > 0.7 & all_CV_Dindices_F$D_CO > 0.7
pos_0.9 <- all_CV_Dindices_F$D_CR > 0.9 & all_CV_Dindices_F$D_CO > 0.9
# CG NEG
median(all_CV_Dindices_F[neg_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[neg_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[neg_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[neg_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[neg_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[neg_0.9,]$cvCG, na.rm = T)
# CG POS
median(all_CV_Dindices_F[pos_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[pos_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[pos_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[pos_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[pos_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_F[pos_0.9,]$cvCG, na.rm = T)
# CR NEG
median(all_CV_Dindices_F[neg_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[neg_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[neg_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[neg_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[neg_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[neg_0.9,]$cvCR, na.rm = T)
# CR POS
median(all_CV_Dindices_F[pos_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[pos_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[pos_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[pos_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[pos_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_F[pos_0.9,]$cvCR, na.rm = T)
# CO NEG
median(all_CV_Dindices_F[neg_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[neg_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[neg_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[neg_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[neg_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[neg_0.9,]$cvCO, na.rm = T)
# CO POS
median(all_CV_Dindices_F[pos_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[pos_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[pos_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[pos_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[pos_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_F[pos_0.9,]$cvCO, na.rm = T)

##################### L - Dco Dcr overlaps
neg_all <- all_CV_Dindices_L$D_CR < 0    & all_CV_Dindices_L$D_CO < 0
neg_0.1 <- all_CV_Dindices_L$D_CR < -0.1 & all_CV_Dindices_L$D_CO < -0.1
neg_0.3 <- all_CV_Dindices_L$D_CR < -0.3 & all_CV_Dindices_L$D_CO < -0.3
neg_0.5 <- all_CV_Dindices_L$D_CR < -0.5 & all_CV_Dindices_L$D_CO < -0.5
neg_0.7 <- all_CV_Dindices_L$D_CR < -0.7 & all_CV_Dindices_L$D_CO < -0.7
neg_0.9 <- all_CV_Dindices_L$D_CR < -0.9 & all_CV_Dindices_L$D_CO < -0.9

pos_all <- all_CV_Dindices_L$D_CR > 0   & all_CV_Dindices_L$D_CO > 0
pos_0.1 <- all_CV_Dindices_L$D_CR > 0.1 & all_CV_Dindices_L$D_CO > 0.1
pos_0.3 <- all_CV_Dindices_L$D_CR > 0.3 & all_CV_Dindices_L$D_CO > 0.3
pos_0.5 <- all_CV_Dindices_L$D_CR > 0.5 & all_CV_Dindices_L$D_CO > 0.5
pos_0.7 <- all_CV_Dindices_L$D_CR > 0.7 & all_CV_Dindices_L$D_CO > 0.7
pos_0.9 <- all_CV_Dindices_L$D_CR > 0.9 & all_CV_Dindices_L$D_CO > 0.9
# CG NEG
median(all_CV_Dindices_L[neg_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[neg_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[neg_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[neg_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[neg_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[neg_0.9,]$cvCG, na.rm = T)
# CG POS
median(all_CV_Dindices_L[pos_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[pos_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[pos_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[pos_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[pos_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_L[pos_0.9,]$cvCG, na.rm = T)
# CR NEG
median(all_CV_Dindices_L[neg_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[neg_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[neg_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[neg_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[neg_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[neg_0.9,]$cvCR, na.rm = T)
# CR POS
median(all_CV_Dindices_L[pos_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[pos_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[pos_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[pos_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[pos_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_L[pos_0.9,]$cvCR, na.rm = T)
# CO NEG
median(all_CV_Dindices_L[neg_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[neg_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[neg_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[neg_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[neg_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[neg_0.9,]$cvCO, na.rm = T)
# CO POS
median(all_CV_Dindices_L[pos_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[pos_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[pos_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[pos_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[pos_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_L[pos_0.9,]$cvCO, na.rm = T)

##################### R - Dco Dcr overlaps
neg_all <- all_CV_Dindices_R$D_CR < 0    & all_CV_Dindices_R$D_CO < 0
neg_0.1 <- all_CV_Dindices_R$D_CR < -0.1 & all_CV_Dindices_R$D_CO < -0.1
neg_0.3 <- all_CV_Dindices_R$D_CR < -0.3 & all_CV_Dindices_R$D_CO < -0.3
neg_0.5 <- all_CV_Dindices_R$D_CR < -0.5 & all_CV_Dindices_R$D_CO < -0.5
neg_0.7 <- all_CV_Dindices_R$D_CR < -0.7 & all_CV_Dindices_R$D_CO < -0.7
neg_0.9 <- all_CV_Dindices_R$D_CR < -0.9 & all_CV_Dindices_R$D_CO < -0.9

pos_all <- all_CV_Dindices_R$D_CR > 0   & all_CV_Dindices_R$D_CO > 0
pos_0.1 <- all_CV_Dindices_R$D_CR > 0.1 & all_CV_Dindices_R$D_CO > 0.1
pos_0.3 <- all_CV_Dindices_R$D_CR > 0.3 & all_CV_Dindices_R$D_CO > 0.3
pos_0.5 <- all_CV_Dindices_R$D_CR > 0.5 & all_CV_Dindices_R$D_CO > 0.5
pos_0.7 <- all_CV_Dindices_R$D_CR > 0.7 & all_CV_Dindices_R$D_CO > 0.7
pos_0.9 <- all_CV_Dindices_R$D_CR > 0.9 & all_CV_Dindices_R$D_CO > 0.9
# CG NEG
median(all_CV_Dindices_R[neg_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[neg_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[neg_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[neg_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[neg_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[neg_0.9,]$cvCG, na.rm = T)
# CG POS
median(all_CV_Dindices_R[pos_all,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[pos_0.1,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[pos_0.3,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[pos_0.5,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[pos_0.7,]$cvCG, na.rm = T)
median(all_CV_Dindices_R[pos_0.9,]$cvCG, na.rm = T)
# CR NEG
median(all_CV_Dindices_R[neg_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[neg_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[neg_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[neg_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[neg_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[neg_0.9,]$cvCR, na.rm = T)
# CR POS
median(all_CV_Dindices_R[pos_all,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[pos_0.1,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[pos_0.3,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[pos_0.5,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[pos_0.7,]$cvCR, na.rm = T)
median(all_CV_Dindices_R[pos_0.9,]$cvCR, na.rm = T)
# CO NEG
median(all_CV_Dindices_R[neg_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[neg_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[neg_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[neg_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[neg_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[neg_0.9,]$cvCO, na.rm = T)
# CO POS
median(all_CV_Dindices_R[pos_all,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[pos_0.1,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[pos_0.3,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[pos_0.5,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[pos_0.7,]$cvCO, na.rm = T)
median(all_CV_Dindices_R[pos_0.9,]$cvCO, na.rm = T)
