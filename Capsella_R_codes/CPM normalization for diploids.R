######################################################
#  CPM normalization for diploids
######################################################
...
Accession <- read.csv("InputData/DiploidsPhenotypicFile.txt", header = T, sep = "\t")
head(Accession)
...
# Filter1: Only retain genes that have at least one expression values for each species
...
libColsums <- colSums(raw.RC + 1, na.rm = T) # add one because later we will have to log values.
data.lib.size <- c()
evenN <- seq(1,36, 2)
...
barplot(data.lib.size/1000000, names.arg=Accession$NewName, las =2, border = F,
       ylab = "Library size (million reads)", cex.names=0.5)
...
write.table(CPMnorm, "InputData/Capsella_Diploids_ReadsCount_CPM_Filtered.txt",  quote = F, sep = "\t", row.names = T)
write.table(logCPMnorm, "InputData/Capsella_Diploids_ReadsCount_logCPM_Filtered.txt",  quote = F, sep = "\t", row.names = T)
...
Cbp_Co_F <- c(Accession$species %in% Cbp_Co & Accession$tissue=="flower")
Cbp_Co_L <- c(Accession$species %in% Cbp_Co & Accession$tissue=="leaf")
Cbp_Co_R <- c(Accession$species %in% Cbp_Co & Accession$tissue=="root")
Cbp_Cg_F <- c(Accession$species %in% Cbp_Cg & Accession$tissue=="flower")
Cbp_Cg_L <- c(Accession$species %in% Cbp_Cg & Accession$tissue=="leaf")
Cbp_Cg_R <- c(Accession$species %in% Cbp_Cg & Accession$tissue=="root")

ASI_Co_F <- c(Accession$species=="ASI_Co" & Accession$tissue=="flower")
EUR_Co_F <- c(Accession$species=="EUR_Co" & Accession$tissue=="flower")
ME_Co_F <- c(Accession$species=="ME_Co" & Accession$tissue=="flower")
CASI_Co_F <- c(Accession$species=="CASI_Co" & Accession$tissue=="flower")

ASI_Cg_F <- c(Accession$species=="ASI_Cg" & Accession$tissue=="flower")
EUR_Cg_F <- c(Accession$species=="EUR_Cg" & Accession$tissue=="flower")
ME_Cg_F <- c(Accession$species=="ME_Cg" & Accession$tissue=="flower")
CASI_Cg_F <- c(Accession$species=="CASI_Cg" & Accession$tissue=="flower")

ASI_Co_L <- c(Accession$species=="ASI_Co" & Accession$tissue=="leaf")
EUR_Co_L <- c(Accession$species=="EUR_Co" & Accession$tissue=="leaf")
ME_Co_L <- c(Accession$species=="ME_Co" & Accession$tissue=="leaf")
CASI_Co_L <- c(Accession$species=="CASI_Co" & Accession$tissue=="leaf")

ASI_Cg_L <- c(Accession$species=="ASI_Cg" & Accession$tissue=="leaf")
EUR_Cg_L <- c(Accession$species=="EUR_Cg" & Accession$tissue=="leaf")
ME_Cg_L <- c(Accession$species=="ME_Cg" & Accession$tissue=="leaf")
CASI_Cg_L <- c(Accession$species=="CASI_Cg" & Accession$tissue=="leaf")

ASI_Co_R <- c(Accession$species=="ASI_Co" & Accession$tissue=="root")
EUR_Co_R <- c(Accession$species=="EUR_Co" & Accession$tissue=="root")
ME_Co_R <- c(Accession$species=="ME_Co" & Accession$tissue=="root")
CASI_Co_R <- c(Accession$species=="CASI_Co" & Accession$tissue=="root")

ASI_Cg_R <- c(Accession$species=="ASI_Cg" & Accession$tissue=="root")
EUR_Cg_R <- c(Accession$species=="EUR_Cg" & Accession$tissue=="root")
ME_Cg_R <- c(Accession$species=="ME_Cg" & Accession$tissue=="root")
CASI_Cg_R <- c(Accession$species=="CASI_Cg" & Accession$tissue=="root")
##############################
